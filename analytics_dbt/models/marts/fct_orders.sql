select
    ...
    oc.order_status,
    cast(oc.order_purchase_timestamp as date) as order_purchase_timestamp,
    cast(oc.order_approved_at as date) as order_approved_at,
    cast(oc.order_delivered_carrier_date as date) as order_delivered_carrier_date,
    cast(oc.order_delivered_customer_date as date) as order_delivered_customer_date,
    cast(oc.order_estimated_delivery_date as date) as order_estimated_delivery_date,
